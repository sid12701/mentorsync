...
import EffortlessIntegration from "../components/landing/effortless-integration";
import MentorSyncStats from "../components/landing/mentor-sync-stats";
...
import NumbersThatSpeak from "../components/landing/faq-section"; // Import NumbersThatSpeak component
import mentorSyncHero from "../assets/landing/mentorsync-hero.jpg";
import maskSVG from "../assets/landing/mask-group-pattern.svg";
import analyticsDashboard from "../assets/landing/analytics-dashboard-with-charts-graphs-and-data-vi.jpg";
import horizonIcon from "../assets/landing/horizon-icon.svg";
import mentorSyncDashboard from "../assets/landing/mentorsync-dashboard.jpg";
            ...
            <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                ...
                <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                  <Link
                    href="/login"
                    className="px-2 sm:px-3 md:px-[14px]
             py-1 sm:py-[6px]
             bg-white
             shadow-[0px_1px_2px_rgba(55,50,47,0.12)]
             rounded-full
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[748.71px] lg:w-[748.71px] text-center flex justify-center flex-col text-gray-900 text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-bold leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 px-2 sm:px-4 md:px-0">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-gray-600 sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Connect with world-class experts instantly. Zero scheduling
                    conflicts.
                    <br className="hidden sm:block" />
                    Global mentorship, perfectly timed for your timezone.
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-[497px] lg:w-[497px] flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative z-10 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
                <div className="backdrop-blur-[8.25px] flex justify-start items-center gap-4">
                  <Link
                    href="/signup"
                    className="h-10 sm:h-11 md:h-12 px-6 sm:px-8 md:px-10 lg:px-12
             py-2 sm:py-[6px]
             ...
             transition-all duration-200"
                  >
                    <span className="text-white text-sm sm:text-base md:text-[15px] font-bold">
                      Get Started
                    </span>
                  </Link>{" "}
                </div>
                  ...
                  <div className="self-stretch flex-1 flex justify-start items-start">
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="relative w-full h-full overflow-hidden">
                        {/* Product Image 1 - Instant Connections */}
                        <div
                        ...
                        >
                          <Image
                            src={mentorSyncHero || "/placeholder.svg"}
                            alt="Instant Expert Connections"
                            fill
                            className="object-cover"
                          />
                        </div>

                        {/* Product Image 2 - Smart Scheduling */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                            activeCard === 1
                              ? "opacity-100 scale-100 blur-0"
                        ...
                        >
                          <Image
                            src={analyticsDashboard || "/placeholder.svg"}
                            alt="Smart Scheduling with Timezone Conversion"
                            className="w-full h-full object-cover"
                          />
                        </div>

                        {/* Product Image 3 - Track Growth */}
                        <div
                          className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                            activeCard === 2
                              ? "opacity-100 scale-100 blur-0"
                        ...
                        >
                          <Image
                            src={mentorSyncDashboard || "/placeholder.svg"}
                            alt="Learning Progress Tracking Dashboard"
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    ...
                    description="Connect with verified experts from 100+ countries. No waiting, no back-and-forth emails."
                  ...
                  <FeatureCard
                    ...
                    description="Our AI handles timezone conversions. Schedule meetings that actually work for everyone."
                  ...
                  <FeatureCard
                    ...
                    description="Monitor learning progress, get personalized recommendations, and accelerate your mastery journey."
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    <Badge
                      icon={
                        <svg
                          width="12"
                    ...
                    <div className="self-stretch text-center text-gray-600 text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Join thousands of ambitious professionals learning from
                      the world's
                      <br className="hidden sm:block" />
                      best mentors, without the scheduling headaches.
                    </div>
                  </div>
                </div>
                      ...
                      return (
                        ...
                        >
                          <div className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 relative shadow-[0px_-4px_8px_rgba(255,255,255,0.64)_inset] overflow-hidden rounded-full">
                            <Image
                              src={horizonIcon || "/placeholder.svg"}
                              alt="Horizon"
                              className="w-full h-full object-contain"
                            />
                          </div>
