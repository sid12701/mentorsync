...
const SmartSimpleBrilliant: React.FC<SmartSimpleBrilliantProps> = ({
  ...
  // Using placeholder SVGs instead of localhost references
  const img = `data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='16' height='16' fill='%23E0E0E0'/%3E%3Ccircle cx='8' cy='8' r='6' fill='%23999'/%3E%3C/svg%3E`
  const img1 = `data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='16' height='16' fill='%23E0E0E0'/%3E%3Crect x='4' y='4' width='8' height='8' fill='%23999'/%3E%3C/svg%3E`
  const img2 = `data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='16' height='16' fill='%23E0E0E0'/%3E%3Ccircle cx='4' cy='4' r='2' fill='%23999'/%3E%3Ccircle cx='12' cy='4' r='2' fill='%23999'/%3E%3Ccircle cx='4' cy='12' r='2' fill='%23999'/%3E%3Ccircle cx='12' cy='12' r='2' fill='%23999'/%3E%3C/svg%3E`
  const img3 = `data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='16' height='16' fill='%23E0E0E0'/%3E%3Cpath d='M8 2L12 6L8 10L4 6Z' fill='%23999'/%3E%3C/svg%3E`
...
export type { SmartSimpleBrilliantProps }
