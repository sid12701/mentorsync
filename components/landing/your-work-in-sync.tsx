...
const YourWorkInSync: React.FC<YourWorkInSyncProps> = ({
  ...
  const imgFrame2147223205 = "../../assets/landing/professional-woman-avatar-with-short-brown-hair-an.jpg"
  const imgFrame2147223206 = "../../assets/landing/professional-man-avatar-with-beard-and-glasses-loo.jpg"
  const imgFrame2147223207 = "../../assets/landing/professional-person-avatar-with-curly-hair-and-war.jpg"
  const imgArrowUp =
