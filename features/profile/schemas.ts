...
export const tutorProfileSchema = baseProfileSchema.extend({
    ...
    subjects: z.array(z.string()).min(1,"At least one subject").max(10,"Maximum 10 subjects"),
    hourlyRate: z.number().min(10, 'Rate must be at least $10/hour').max(500, 'Rate must be less than $500/hour'),
})
